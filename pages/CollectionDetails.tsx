            ...
            isConnected ? (
                <div className=" flex w-full  flex-col lg:flex-row items-center min-h-[80vh] py-9">
                    <div className="lg:w-[40%]">
                        <img className="object-cover" src={collection.collectionImage} alt="" />
                    </div>
                    <div className=" w-full lg:w-[60%] min-h-[400px] mb-5 lg:p-5 p-3 my-6">
                        ...
                        <div className="py-5 border-b border-purple-400">
                            <p>Created By : {collection.collectionName}</p>
                        </div>
                        <div className="py-3">
                        ...
                        <div className="flex flex-col lg:flex-row mt-9 ">
                            <DetailsBadge title="price" value={collection.collectionPrice + " Matic"} />
                            <DetailsBadge title="tickets" value={collection.numberOfTokensOnSale} />
                            <DetailsBadge title="Adress" value={collection.collectionContractId.slice(0, 5)} />
                        </div>
                    </div>
                </div>
            ) : null
